...
export default function BookingMcLoading() {
  return (
    <main className="admin-surface min-h-svh space-y-6 p-4 sm:p-6 lg:p-8" aria-busy="true" aria-label="Memuat Booking MC">
      {/* Page Header */}
      ...
      <div className="rounded-2xl border bg-card overflow-hidden">
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="flex items-center gap-4 py-2 border-b">
            ...
            <Skeleton className="h-5 w-36 rounded bg-secondary" />
          ...
          {Array.from({ length: 5 }).map((_, i) => (
            <div key={i} className="flex items-center gap-4 py-3 border-b last:border-0">
              ...
              <Skeleton className="h-5 w-32 rounded bg-secondary/80" />
              <Skeleton className="h-5 w-24 rounded bg-secondary/80" />
              <Skeleton className="h-5 w-28 rounded bg-secondary/80" />
              <Skeleton className="h-5 w-36 rounded bg-secondary/80" />
              <Skeleton className="h-6 w-20 rounded-full bg-secondary/80" />
