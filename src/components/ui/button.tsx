...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-full border text-sm font-bold whitespace-nowrap transition-all duration-200 outline-none select-none focus-visible:ring-3 focus-visible:ring-ring/35 focus-visible:ring-offset-2 focus-visible:ring-offset-background active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-55 aria-busy:cursor-wait aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "border-x-[#284f3f] border-t-[#6f9381] border-b-[#0c251c] bg-gradient-to-b from-[#315c46] via-[#214b3a] to-[#173e31] text-primary-foreground shadow-[inset_0_1px_0_rgba(255,255,255,.28),inset_0_-2px_0_rgba(7,30,21,.56),0_3px_0_#0e2d22] hover:translate-y-0.5 hover:from-[#3d6c54] hover:via-[#285541] hover:to-[#1a4737] hover:shadow-[inset_0_1px_0_rgba(255,255,255,.32),inset_0_-2px_0_rgba(7,30,21,.5),0_1px_0_#0e2d22] active:translate-y-1 active:shadow-[inset_0_2px_5px_rgba(7,30,21,.38),0_0_0_#0e2d22] disabled:translate-y-0 disabled:shadow-[inset_0_1px_0_rgba(255,255,255,.2),0_2px_0_#1e4234]",
        outline:
          "border-border bg-gradient-to-b from-white via-[#fffdf7] to-[#edf1e9] text-foreground shadow-[inset_0_1px_0_rgba(255,255,255,.9),inset_0_-1px_0_rgba(23,62,49,.12),0_3px_0_#c6d0c1] hover:translate-y-0.5 hover:border-[#9db09a] hover:to-[#e5ecdf] hover:text-primary hover:shadow-[inset_0_1px_0_rgba(255,255,255,1),inset_0_-1px_0_rgba(23,62,49,.15),0_1px_0_#b5c2b0] active:translate-y-1 active:shadow-[inset_0_2px_4px_rgba(23,62,49,.13),0_0_0_#c6d0c1] aria-expanded:bg-secondary",
        secondary:
          "border-[#b9c9b4] bg-gradient-to-b from-[#edf3e9] via-secondary to-[#cbd9c5] text-secondary-foreground shadow-[inset_0_1px_0_rgba(255,255,255,.75),inset_0_-1px_0_rgba(23,62,49,.12),0_3px_0_#adbea8] hover:translate-y-0.5 hover:brightness-[1.02] hover:shadow-[inset_0_1px_0_rgba(255,255,255,.85),inset_0_-1px_0_rgba(23,62,49,.15),0_1px_0_#adbea8] active:translate-y-1 active:shadow-[inset_0_2px_4px_rgba(23,62,49,.15),0_0_0_#adbea8] aria-expanded:bg-secondary",
        ghost:
        ...
        destructive:
          "border-[#7e2925] bg-gradient-to-b from-[#c65b52] to-destructive text-white shadow-[inset_0_1px_0_rgba(255,255,255,.25),inset_0_-2px_0_rgba(72,18,15,.35),0_3px_0_#7e2925] hover:translate-y-0.5 hover:brightness-105 hover:shadow-[inset_0_1px_0_rgba(255,255,255,.3),inset_0_-2px_0_rgba(72,18,15,.4),0_1px_0_#7e2925] active:translate-y-1 active:shadow-[inset_0_2px_4px_rgba(72,18,15,.35),0_0_0_#7e2925] focus-visible:ring-destructive/30",
